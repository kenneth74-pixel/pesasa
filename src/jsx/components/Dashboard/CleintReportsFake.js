...
import WalletTab from "../Boltz/MyWallet/WalletTab.js";
...
const SummarApexBar = loadable(() =>
	pMinDelay(import("../Boltz/Portfolio/SummarApexBar.js"), 1000)
);
const CurrentApexBar = loadable(() =>
	pMinDelay(import("../Boltz/Portfolio/CurrentApexBar.js"), 1000)
);
...
const MarketLineApex = loadable(() =>
	pMinDelay(import("../Boltz/Home/MarketLineApex.js"), 1000)
);
...
const Portofolio = ({hideDetail, setRange, setAddFormDataTwo, getBuyersInfo}) =>{
	...
	const [regionStats, setregionStats]= useState([
		...
		{name:"Nothern",clientsAvailable:72, revenue:"623,000,000"},
		{name:"Eastern",clientsAvailable:110, revenue:"953,000,000"},
		{name:"Western",clientsAvailable:45, revenue:"390,000,000"},
		{name:"Central",clientsAvailable:126, revenue:"1,000,000,000"}
	]);
								...
								<div className="mb-2 coin-bx">
									<div className="d-flex align-items-center">
										...
										<div className="ms-3">
											...
											{/* <b className="mb-0 op-6" style={{color:"#000"}}>Total: 135</b> */}
										</div>
									</div>
								</div>
								<div className="mb-2">
									<div className="d-flex align-items-center">
										...
										<div className="ms-3">
											<h2 className="mb-0 text-primary coin-font-1">135</h2>
										</div>
									</div>
									<div className="d-flex align-items-center">
										<div className="coin-bx-one text-black">
										...
										<div className="ms-3">
											<h2 className="mb-0 text-primary coin-font-1">105</h2>
										</div>
									</div>
									...
									<div className="d-flex align-items-center">
										...
										<div className="ms-3">
											<h2 className="mb-0 text-primary coin-font-1">30</h2>
										</div>
									</div>
									...
									<div className="d-flex align-items-center">
										...
										<div className="ms-3">
											<h2 className="mb-0 text-primary coin-font-1">210</h2>
										</div>
									</div>
...
{regionStats?.map((option) => {return <div className="d-flex align-items-center">
										<div className="text-black">
										{option.name} :
										</div>	
										<div className="ms-3">
										...
										<div style={{marginLeft:"10px"}}>
											<font className="text-black">Total Portifolio:</font>
											
											<font className="text-primary" style={{marginLeft:"10px"}}>{option.revenue}</font> 
										</div>
									</div>})}
								...
								<div className="mb-2">
								<b className='text-black'>Pie-Chart Representaion Of Regions</b>
								<ReactApexChart
				   options={{
					chart: {
						height: 250,
					...
					//colors:['#374C98', '#FFAB2D', '#FF782C', '#00ADA3'],
					colors:['#096','#374C98', '#FFAB2D', '#FF782C'],
					labels:["Nothern", "Eastern", "Western", "Central"],
					legend: {
						position: 'bottom',
						show:false
					},
