                ...
                {defaultAccordion.map((d, i) => (
                  <div className="accordion-item" key={i}>
                    <Accordion.Toggle
                      as={Card.Text}
                      eventKey={`${i}`}
                      className={`accordion-header rounded-lg ${activeDefault === i ? "" : "collapsed"
                        }`}
                      onClick={() =>
                ...
                {defaultAccordion.map((d, i) => (
                  <div className="accordion-item" key={i}>
                    <Accordion.Toggle
                      as={Card.Text}
                      eventKey={`${i}`}
                      className={`accordion-header  ${activeWithoutSpace === i ? "" : "collapsed"
                        }`}
                      onClick={() =>
                ...
                {defaultAccordion.map((d, i) => (
                  <div className="accordion-item" key={i}>
                    <Accordion.Toggle
                      as={Card.Text}
                      eventKey={`${i}`}
                      className={`accordion-header ${activeWithoutSpaceBordered === i ? "" : "collapsed"
                        }`}
                      onClick={() =>
                ...
                {defaultAccordion.map((d, i) => (
                  <div className="accordion-item" key={i}>
                    <Accordion.Toggle
                      as={Card.Text}
                      eventKey={`${i}`}
                      className={`accordion-header ${activeIndicatorInLeftPosition === i ? "" : "collapsed"
                        }`}
                      onClick={() =>
                        setActiveIndicatorInLeftPosition(
                ...
                {defaultAccordion.map((d, i) => (
                  <div className="accordion-item" key={i}>
                    <Accordion.Toggle
                      as={Card.Text}
                      eventKey={`${i}`}
                      className={`accordion-header ${activeAccordionWithIcon === i ? "" : "collapsed"
                        }`}
                      onClick={() =>
                ...
                {defaultAccordion.map((d, i) => (
                  <div className="accordion-item" key={i}>
                    <Accordion.Toggle
                      as={Card.Text}
                      eventKey={`${i}`}
                      className={`accordion-header ${activeAccordionSolidBg === i ? "" : "collapsed"
                ...
                {defaultAccordion.map((d, i) => (
                  <div className="accordion-item" key={i}>
                    <Accordion.Toggle
                      as={Card.Text}
                      eventKey={`${i}`}
                      className={`accordion-header ${activeAccordionActiveHeader === i ? "" : "collapsed"
                        } accordion-header-primary`}
                      onClick={() =>
                        setActiveAccordionActiveHeader(
                ...
                {defaultAccordion.map((d, i) => (
                  <div className="accordion-item" key={i}>
                    <Accordion.Toggle
                      as={Card.Text}
                      eventKey={`${i}`}
                      className={`accordion-header ${activeAccordionHeaderShadow === i ? "" : "collapsed"
                        } accordion-header--primary`}
                      onClick={() =>
                        setActiveAccordionHeaderShadow(
                ...
                {defaultAccordion.map((d, i) => (
                  <div className="accordion-item" key={i}>
                    <Accordion.Toggle
                      as={Card.Text}
                      eventKey={`${i}`}
                      className={`accordion-header ${activeaccordionRoundedStylish === i ? "" : "collapsed"
                        } accordion-header-primary`}
                      onClick={() =>
                        setActiveaccordionRoundedStylish(
                ...
                {defaultAccordion.map((d, i) => (
                  <div className="accordion-item" key={i}>
                    <Accordion.Toggle
                      as={Card.Text}
                      eventKey={`${i}`}
                      className={`accordion-header ${activeAccordionGradient === i ? "" : "collapsed"
                        } accordion-header--primary`}
                      onClick={() =>
