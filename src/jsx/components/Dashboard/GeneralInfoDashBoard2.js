...
import {getSummaryPayments, getSummaryPaymentsByYearOrMonth ,
	...
	getSummaryPaymentsByDateRange, getSummaryPaymentsForWholeYear} from "../../../util/APIUtils.js";
...
function loadParentData(){
	...
	function getYearSumm(year){
		getSummaryPaymentsForWholeYear(year)
		.then((response) => {
			//alert(JSON.stringify(response))
			setYearSum(response)
	...
	return(
		...
		{hideMenu?null:
			<div className="mb-sm-5 mb-3 d-flex flex-wrap align-items-center text-head">
				<h2 className="font-w600 mb-2 me-auto">Payments Summary</h2>
				...
				<div  className={hideMenu?"col-xl-12 col-xxl-12":"col-xl-8 col-xxl-8"} >
					<div className="card">
						<div className="card-header border-0 pb-0">
							<h4 className="mb-0 fs-20 text-black">Payments Totals For {theData.name}</h4>
							<DropdownBlog />
						</div>
							...
							<div className="bg-gradient-1 coin-holding flex-wrap" style={{flexDirection:"row"}}>
								<div className="mb-2 coin-bx" style={{flex:1}}>
									<div className="d-flex align-items-center">
										...
										<div className="ms-3">
											<h4 className="coin-font font-w600 mb-0">All Payments</h4>
							...
							<div className="bg-gradient-2 coin-holding mt-4 flex-wrap" style={{flexDirection:"row"}}>
								<div className="mb-2 coin-bx" style={{flex:1}}>
									<div className="d-flex align-items-center">
										...
										<div className="ms-3">
											<h4 className="coin-font font-w600 mb-0">Pending Payments</h4>
							...
							<div className="bg-gradient-3 coin-holding mt-4 flex-wrap" style={{flexDirection:"row"}}>
								<div className="mb-2 coin-bx"  style={{flex:1}}>
									<div className="d-flex align-items-center">
										...
										<div className="ms-3">
											<h4 className="coin-font font-w600 mb-0">Paid Applications</h4>
