...
import {getSummaryCollections, getSummaryCollectionsByYearOrMonth ,
	getSummaryCollectionsByDaysFig,
	getSummaryCollectionsByDateRange, getSummaryCollectionsForWholeYear} from "../../../util/APIUtils.js";
...
function loadParentData(){
	...
	useEffect(() => {
	  ...
	  function pickData2(){
		...
		getSummaryCollectionsByDateRange(addFormData)
		.then((response) => {
	  ...
	  function pickData(){
		...
		setAddFormDataTwo(addFormData)
		getSummaryCollectionsByYearOrMonth(addFormData)
		.then((response) => {
			//alert(JSON.stringify(response))
	...
	function pickData3(){
		...
		setRange("daysNumber")
		setAddFormDataTwo(addFormData)
		getSummaryCollectionsByDaysFig(addFormData)
		.then((response) => {
			//alert(JSON.stringify(response))
	...
	return(
		...
		{hideMenu?null:
			<div className="mb-sm-5 mb-3 d-flex flex-wrap align-items-center text-head">
				<h2 className="font-w600 mb-2 me-auto">Collections Summary</h2>
					...
					<div className="card">
						...
						<div className="form-group ">
							<b style={{color:"black"}}><u>Filter By No. Of Days</u></b>
												...
												<span className="validation-text">	Collections waiting for more than </span>
												<div >
												<div className="row">
				...
				<div  className={hideMenu?"col-xl-12 col-xxl-12":"col-xl-8 col-xxl-8"} >
					<div className="card">
						<div className="card-header border-0 pb-0">
							<h4 className="mb-0 fs-20 text-black">Collections Totals For {theData.name}</h4>
							<DropdownBlog />
						</div>
						<div className="card-body">
							<div className="bg-gradient-1 coin-holding flex-wrap" style={{flexDirection:"row"}}>
								<div className="mb-2 coin-bx" style={{flex:1}}>
									<div className="d-flex align-items-center">
										...
										<div className="ms-3">
											<h4 className="coin-font font-w600 mb-0">All Collections</h4>
							...
							{/* <div className="bg-gradient-2 coin-holding mt-4 flex-wrap" style={{flexDirection:"row"}}>
								<div className="mb-2 coin-bx" style={{flex:1}}>
									<div className="d-flex align-items-center">
										...
										<div className="ms-3">
											<h4 className="coin-font font-w600 mb-0">Pending Normal Collections</h4>
							...
							<div className="bg-gradient-3 coin-holding mt-4 " style={{flexDirection:"row"}}>
								<div className="mb-2 coin-bx"  style={{flex:1}}>
									<div className="d-flex align-items-center">
										
										<div className="ms-3" >
											<h4 className="coin-font font-w600 mb-0">Collected Payments</h4>
							...
							<div className="bg-gradient-4 coin-holding mt-4 flex-wrap"  style={{flexDirection:"row"}}>
								<div className="mb-2 coin-bx" style={{flex:1}}>
									<div className="d-flex align-items-center"  >
										...
										<div className="ms-3">
											<h4 className="coin-font font-w600 mb-0">Pending Overdue Payments</h4>
							...
							{/* <div className="bg-gradient-4 coin-holding mt-4 flex-wrap" style={{flexDirection:"row"}}>
								<div className="mb-2 coin-bx" style={{flex:1}}>
									<div className="d-flex align-items-center">
										...
										<div className="ms-3">
											<h4 className="coin-font font-w600 mb-0">Revenue (Fees)</h4>
										</div>
									</div>
								</div>
								<div className="mb-2" style={{flex:1}}>
									<div className="d-flex align-items-center">
										...
										<div className="ms-3">
											<h2 className="mb-0 text-primary coin-font-1">UGX.{numberWithCommas(theData.revenue?.toFixed(2))}</h2>
										</div>
									</div>
								</div>
								<div className="mb-2">
							...
							<div className="bg-gradient-4 coin-holding mt-4 flex-wrap" style={{flexDirection:"row"}}>
								<div className="mb-2 coin-bx" style={{flex:1}}>
									<div className="d-flex align-items-center">
										...
										<div className="ms-3">
											<h4 className="coin-font font-w600 mb-0">Revenue (Fines)</h4>
										</div>
									</div>
								</div>
								<div className="mb-2" style={{flex:1}}>
									<div className="d-flex align-items-center">
										...
										<div className="ms-3">
											<h2 className="mb-0 text-primary coin-font-1">UGX.{numberWithCommas(theData.revenueFines?.toFixed(2))}</h2>
										</div>
									</div>
								</div>
								<div className="mb-2">
							...
							<div className="bg-gradient-4 coin-holding mt-4 flex-wrap" style={{flexDirection:"row"}}>
								<div className="mb-2 coin-bx" style={{flex:1}}>
									<div className="d-flex align-items-center">
										...
										<div className="ms-3">
											<h4 className="coin-font font-w600 mb-0">Revenue (Total)</h4>
										</div>
									</div>
								</div>
								<div className="mb-2" style={{flex:1}}>
									<div className="d-flex align-items-center">
										...
										<div className="ms-3">
											<h2 className="mb-0 text-primary coin-font-1">UGX.{numberWithCommas(theData.revenueTotal?.toFixed(2))}</h2>
										</div>
									</div>
								</div>
								<div className="mb-2">
			...
			<div className="row">
				...
				<div className={theData.length>0?"col-xl-8":"col-xl-12"}>
					<div className="row">
						...
						<div className="card">
								<div className="card-header pb-0 border-0">
									<h4 className="fs-20 text-black mb-0">Yearly  Collections Totals Summary For the Year {addFormData.year}</h4>
								</div>
