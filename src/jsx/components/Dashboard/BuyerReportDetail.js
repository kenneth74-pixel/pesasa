...
import {getSummaryPayments, getSummaryPaymentsByYearOrMonth ,
	...
	getSummaryPaymentsByDateRange, getBuyersSummary} from "../../../util/APIUtils.js";
...
const Portofolio = ({hideDetail, setRange, setAddFormDataTwo, getBuyersInfo}) =>{
	...
	const [summaryData, setSummaryData] = useState({sectorCoverage:[], buyersDetail:[]});
...
function loadParentData(){
	...
	function getYearSumm(){
		...
		.then((response) => {
			//alert(JSON.stringify(response))
			response.buyersDetail.map((option) => {
				option.totalCreditLimit=numberWithCommas(option.totalCreditLimit)
				option.totalCreditDue=numberWithCommas(option.totalCreditDue)
				option.hasDues=option.hasDues?"Yes":"No"
			})
	...
	return(
		...
		{hideMenu?null:
			<div className="mb-sm-5 mb-3 d-flex flex-wrap align-items-center text-head">
				<h2 className="font-w600 mb-2 me-auto">Buyers Report</h2>
				...
				<div  className={hideMenu?"col-xl-12 col-xxl-12":"col-xl-8 col-xxl-8"} >
					<div className="card">
						<div className="card-header border-0 pb-0">
							<h4 className="mb-0 fs-20 text-black">Buyers Report</h4>
							<DropdownBlog />
						</div>
							...
							<div className="bg-gradient-1 coin-holding flex-wrap">
								<div className="mb-2 coin-bx">
									<div className="d-flex align-items-center">
										...
										<div className="ms-3">
											<h4 className="coin-font font-w600 mb-0">All Buyers</h4>
											<b className="mb-0 op-6" style={{color:"#000"}}>Total: {summaryData.buyersTotal}</b>
										</div>
									</div>
								</div>
								<div className="mb-2">
							...
							<div className="bg-gradient-2 coin-holding mt-4 flex-wrap">
								<div className="mb-2 coin-bx">
									<div className="d-flex align-items-center">
										...
										<div className="ms-3">
											<h4 className="coin-font font-w600 mb-0">Sector Coverage</h4>
								...
								hideDataExport={true}
					 rows={summaryData.sectorCoverage!==null?summaryData.sectorCoverage:[]}
					 //rows={this.state.colors[1]==="primary"?finished: dataTemp}
											columns={[
								  { name: 'name', title: 'Sector Name' },
								  { name: 'numberOfBuyers', title: 'Buyers In Sector' },
							...
							<div className="bg-gradient-2 coin-holding mt-4 flex-wrap">
								<div className="mb-2 coin-bx">
									<div className="d-flex align-items-center">
										...
										<div className="ms-3">
											<h4 className="coin-font font-w600 mb-0">Buyer Stats</h4>
								...
								hideDataExport={true}
					 rows={summaryData.buyersDetail!==null?summaryData.buyersDetail:[]}
					 //rows={this.state.colors[1]==="primary"?finished: dataTemp}
											columns={[
								  { name: 'name', title: 'Buyer' },
								  { name: 'totalNumberOfClients', title: 'Clients Total' },
								  { name: 'totalInvoices', title: 'Invoices Total' },
								  { name: 'totalCreditLimit', title: 'Credit Limit Total' },
								  { name: 'hasDues', title: 'Has Dues' },
								  { name: 'totalInvoicesWithDue', title: 'Total Invoices With Dues' },
								  { name: 'totalCreditDue', title: 'Total Due Amount' },
